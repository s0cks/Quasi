package io.github.s0cks.quasi.reflect;
...
public final class Types {
    public static boolean equals(Type type1, Type type2) {
        if (type1 == type2) {
            ...
            return p1.getOwnerType().equals(p2.getOwnerType()) && p1.getRawType().equals(p2.getRawType()) && Arrays
                                                                                                                     .equals(p1.getActualTypeArguments(), p2.getActualTypeArguments());
            ...
            return Arrays.equals(w1.getUpperBounds(), w2.getUpperBounds()) && Arrays.equals(w1.getLowerBounds(), w2
                                                                                                                         .getLowerBounds());
            ...
            return v1.getGenericDeclaration().equals(v2.getGenericDeclaration()) && v1.getName().equals(v2.getName());
        } else {
            return false;
        }
    }
    ...
    public static Class<?> getRawType(Type type) {
        if (type instanceof Class<?>) {
            ...
            if (!(rawType instanceof Class<?>)) {
                throw new IllegalStateException("Expected a Class, but " + type + " is of type " + type.getClass()
                                                                                                       .getName());
            }
            ...
            throw new IllegalArgumentException("Expected a Class, ParamterizedType, GenericArrayType, or TypeVariable" +
                                                       " but got " + type.getClass().getName());
        }
    }
}